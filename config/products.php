...
return [
    ...
    'life-reset-retreat5' => ['name' => 'life-reset-retreat5', 'price' => 2900, 'desc' => '', 'meal' => 0],
    'sunrise-life-reset-service' => ['name' => 'Life Reset Coaching 1', 'price' => 199, 'desc' => '', 'meal' => 0],
    'life-reset-coaching1' => ['name' => 'Life Reset Coaching 1', 'price' => 199, 'desc' => '', 'meal' => 0],
    'life-reset-coaching4' => ['name' => 'Life Reset Coaching 4', 'price' => 749, 'desc' => '', 'meal' => 0],
    'life-reset-coaching8' => ['name' => 'Life Reset Coaching 8', 'price' => 1490, 'desc' => '', 'meal' => 0],

    'wrist-straps' => ['name' => 'WRIST STRAPS', 'price' => 10, 'desc' => 'Lifting Wrist Straps for Weightlifting, Bodybuilding, Powerlifting, Strength Training.', 'meal' => 0],
    'sliders' => ['name' => 'EXERCISE SLIDERS', 'price' => 8, 'desc' => 'Exercise Sliders for Working Out, Fitness Disc for Women and Men, 2 pack', 'meal' => 0],
    'booty-bands' => ['name' => 'BOOTY BANDS', 'price' => 15, 'desc' => 'Booty exercise bands for women and men, glute, hip and thigh resistance bands with carrying bag', 'meal' => 0],
    'ankle-straps' => ['name' => 'ANKLE STRAPS', 'price' => 19, 'desc' => 'Ankle straps for cable machine kickbacks, glute workouts, lower body exercises.', 'meal' => 0],

    'intentional-make-over' => ['name' => 'INTENTIONAL MAKE OVER (Evaluation)', 'price' => 129, 'desc' => 'Redesign your home, office, or online presence with purpose. Our Intentional Makeover service helps you refresh rooms, kitchens, or even your Instagram, aligning beauty, function, and energy to reflect your best self. Evaluation for 129 USD.', 'meal' => 0],

    'mind-reset-program' => ['name' => 'Mind Reset Program', 'price' => 199, 'desc' => '', 'meal' => 0],
    'life-reset-program' => ['name' => 'Life Reset Program', 'price' => 199, 'desc' => '', 'meal' => 0],

    'fit-forever' => ['name' => 'Fit Forever', 'price' => 499, 'desc' => 'Fit.Forever. is a full body fitness program built for lasting results. It blends strength, cardio, and functional mobility with personalized routines that adapt to your level. Unlike typical programs, it includes live weekly workouts, lifestyle tracking, and real time feedback, helping you stay consistent, motivated, and fit for life.', 'meal' => 0],
