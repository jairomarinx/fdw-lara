            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                	<div class="d-flex align-items-center justify-content-center justify-content-md-start">
                        <div class="lng_dropdown me-2 d-none">
                        ...
                        <div class="me-3 d-none">
                            <select name="countries" class="custome_select d-none">
                        ...
                        <ul class="contact_detail text-center text-lg-start">
                            <li><i class="ti-mobile"></i><span>+1 954-226-4294</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
...
<div class="banner_section slide_medium shop_banner_slider staggered-animation-wrap">
    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active background_bg" data-img-src="assets/images/shop-big-1.webp">
                <div class="banner_slide_content">
                    <div class="container"><!-- STRART CONTAINER -->
                        <div class="row">
                            <div class="col-lg-7 col-9">
                                <div class="banner_content overflow-hidden">
                                	<h5 class="mb-3 staggered-animation font-weight-light text-white" data-animation="slideInLeft" data-animation-delay="0.5s">FitDoneWell 3 Fabric Booty Exercise Bands</h5>
                                    <h2 class="staggered-animation text-white" data-animation="slideInLeft" data-animation-delay="1s">Exercise Bands</h2>
                                    <a class="btn btn-fill-out rounded-0 staggered-animation text-uppercase" href="https://www.amazon.com/dp/B0DWD4HJHW?ref=cm_sw_r_cso_cp_apin_dp_9QEGMNZJJGAYAZ2GXD2H_1&ref_=cm_sw_r_cso_cp_apin_dp_9QEGMNZJJGAYAZ2GXD2H_1&social_share=cm_sw_r_cso_cp_apin_dp_9QEGMNZJJGAYAZ2GXD2H_1&starsLeft=1&th=1" data-animation="slideInLeft" data-animation-delay="1.5s">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div><!-- END CONTAINER-->
            ...
            <div class="carousel-item background_bg" data-img-src="assets/images/shop-disk-new.webp">
                <div class="banner_slide_content">
                    <div class="container"><!-- STRART CONTAINER -->
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="banner_content overflow-hidden">
                                	<h5 class="mb-3 staggered-animation font-weight-light text-white" data-animation="slideInLeft" data-animation-delay="0.5s">Exercise Sliders for Working Out</h5>
                                    <h2 class="staggered-animation text-white" data-animation="slideInLeft" data-animation-delay="1s">Fitness Discs</h2>
                                    <a class="btn btn-fill-out rounded-0 staggered-animation text-uppercase" href="https://www.amazon.com/dp/B0DYQHZ5XF?ref=cm_sw_r_cso_cp_apin_dp_XMXPSFNATSTK190DG725&ref_=cm_sw_r_cso_cp_apin_dp_XMXPSFNATSTK190DG725&social_share=cm_sw_r_cso_cp_apin_dp_XMXPSFNATSTK190DG725&starsLeft=1" data-animation="slideInLeft" data-animation-delay="1.5s">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div><!-- END CONTAINER-->
            ...
            <div class="carousel-item background_bg" data-img-src="assets/images/d3.webp">
                <div class="banner_slide_content">
                    <div class="container"><!-- STRART CONTAINER -->
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="banner_content overflow-hidden">
                                	<h5 class="mb-3 staggered-animation font-weight-light text-white" data-animation="slideInLeft" data-animation-delay="0.5s">ifting Wrist Straps for Weightlifting   </h5>
                                    <h2 class="staggered-animation text-white" data-animation="slideInLeft" data-animation-delay="1s">Lifting Wrist Straps</h2>
                                    <a class="btn btn-fill-out rounded-0 staggered-animation text-uppercase" href="https://www.amazon.com/dp/B0DYQRDRYK?ref=cm_sw_r_cso_cp_apin_dp_D2XP34KXT15212N5K7QC&ref_=cm_sw_r_cso_cp_apin_dp_D2XP34KXT15212N5K7QC&social_share=cm_sw_r_cso_cp_apin_dp_D2XP34KXT15212N5K7QC&starsLeft=1" data-animation="slideInLeft" data-animation-delay="1.5s">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div><!-- END CONTAINER-->
    	...
    	<div class="row">
        	<div class="col-md-6">
            	<div class="single_banner">
                	<img src="assets/images/shop1.jpg" alt="shop_banner_img1"/>
                    <div class="single_banner_info">
                        <h5 class="single_bn_title1 text-white">Super Sale</h5>
                        <h3 class="single_bn_title text-white">Booty Exercise Bands</h3>
                        <a href="https://www.amazon.com/dp/B0DWD4HJHW?ref=cm_sw_r_cso_cp_apin_dp_9QEGMNZJJGAYAZ2GXD2H_1&ref_=cm_sw_r_cso_cp_apin_dp_9QEGMNZJJGAYAZ2GXD2H_1&social_share=cm_sw_r_cso_cp_apin_dp_9QEGMNZJJGAYAZ2GXD2H_1&starsLeft=1&th=1" class="single_bn_link text-white">Shop Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
            	<div class="single_banner">
                	<img src="assets/images/shop2.jpg" alt="shop_banner_img2"/>
                    <div class="single_banner_info">
                        <h3 class="single_bn_title text-white">Women & Men - Glute</h3>
                        <h4 class="single_bn_title1 text-white">Thigh Resistance Bands</h4>
                        <a href="https://www.amazon.com/dp/B0DWD4HJHW?ref=cm_sw_r_cso_cp_apin_dp_9QEGMNZJJGAYAZ2GXD2H_1&ref_=cm_sw_r_cso_cp_apin_dp_9QEGMNZJJGAYAZ2GXD2H_1&social_share=cm_sw_r_cso_cp_apin_dp_9QEGMNZJJGAYAZ2GXD2H_1&starsLeft=1&th=1" class="single_bn_link text-white">Shop Now</a>
                    </div>
                </div>
            </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-12 text-center">
                <h4>Our newest Product!</h4>
                <h1>Fit.Without.Gym</h1>
                <a href="fitwithoutgym/">
                    <div>
                        <img src="assets/images/laly-band1.webp" alt="">
                    </div>
                </a>
        </div>
    </div>
                        ...
                        <div class="row shop_container">
                                ...
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="assets/images/shop7.jpg" alt="product_img1">
                                        </a>
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="https://www.amazon.com/dp/B0DYQHZ5XF?ref=cm_sw_r_cso_cp_apin_dp_XMXPSFNATSTK190DG725&ref_=cm_sw_r_cso_cp_apin_dp_XMXPSFNATSTK190DG725&social_share=cm_sw_r_cso_cp_apin_dp_XMXPSFNATSTK190DG725&starsLeft=1">Fitness Discs for Women and Men</a></h6>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="assets/images/shop8.jpg" alt="product_img2">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="https://www.amazon.com/dp/B0DYQRDRYK?ref=cm_sw_r_cso_cp_apin_dp_D2XP34KXT15212N5K7QC&ref_=cm_sw_r_cso_cp_apin_dp_D2XP34KXT15212N5K7QC&social_share=cm_sw_r_cso_cp_apin_dp_D2XP34KXT15212N5K7QC&starsLeft=1">Lifting Wrist Straps</a></h6>
                                        <div class="product_price">
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="assets/images/shop9.jpg" alt="product_img3">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="https://www.amazon.com/dp/B0DWD4HJHW?ref=cm_sw_r_cso_cp_apin_dp_9QEGMNZJJGAYAZ2GXD2H_1&ref_=cm_sw_r_cso_cp_apin_dp_9QEGMNZJJGAYAZ2GXD2H_1&social_share=cm_sw_r_cso_cp_apin_dp_9QEGMNZJJGAYAZ2GXD2H_1&starsLeft=1&th=1">Booty Exercise Bands</a></h6>
                                        <div class="product_price">
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="assets/images/shop12.jpg" alt="product_img4">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="shop-product-detail.html">Thigh Resistance Bands</a></h6>
                                        <div class="product_price">
    	...
    	<div class="row align-items-center flex-row-reverse">
            ...
            <div class="col-md-5">
                <div class="text-center trading_img">
                    <img src="assets//images/laly-sinback.png" alt="tranding_img"/>
                </div>
            </div>
        </div>
    </div>
...
<div class="section bg_redon d-none">
	<div class="container">
    	<div class="row justify-content-center">
        	<div class="col-md-6">
            	<div class="heading_s1 text-center">
...
<div class="section pb_70 d-none">
    	<div class="container">
            <div class="row g-0">
                <div class="col-lg-4">	
