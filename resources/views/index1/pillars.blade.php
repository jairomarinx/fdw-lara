        ...
        <div class="row g-5 gb-5">
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded text-justify p-5">
                    ...
                    <a href="{{ route('fit-reset-programs') }}" class="btn btn-warning d-block text-center mx-auto mt-4">FIT.RESET.PROGRAMS.</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded text-justify p-5">
                    ...
                    <a href="{{ route('mind-reset-programs') }}" class="btn btn-warning d-block text-center mx-auto mt-4">MIND.RESET.PROGRAMS.</a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded text-justify p-5">
                    ...
                    <a href="{{ route('life-reset-programs') }}" class="btn btn-warning d-block text-center mx-auto mt-4">LIFE.RESET.PROGRAMS.</a>
