<div style="background-color: #fff ;" class="p-4">
    <div class="container mb-5 text-center" id="id_schedule">
        ...
        <h5 class="text-gray fs-2"> Zero Equipment <span class="text-primary">• Body Power </span>• Limitless Strength •
        </h5>
        ...
        <div class="row mt-3">
            <div class="col-10 mx-auto">
                ...
                <div class="container-fluid programe position-relative px-5 mt-5" style="margin-bottom: 30px;">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="bg-light rounded text-justify p-5 shadow">
                                ...
                                <a href="{{ route('fit-without-gym') }}"
                                    ...
                                    More<br> <strong>Fit Without Gym</strong></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="bg-light rounded text-justify p-5 shadow">
                                ...
                                <a href="{{ route('fit-without-gym') }}"
                                    class="btn btn-warning d-block text-center mx-auto mt-4">Learn More<br> <strong>Fit
                                        Without Gym</strong></a>
                    ...
                    <p style="color:black; margin-top: 30px;">Discover Fit.Without.Gym:
                        Your New Way to Transform
                        Your Body from Home
                        Imagine getting in shape, feeling energized, and looking amazing, all without ever stepping into
                        a gym!
