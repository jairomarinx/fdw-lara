...
<div class="container">
    ...
    <div class="fdw-hero-shop fdw-fadein" data-fade>
        <span class="fdw-pill mb-3 fs-1 bold"></span>
        <h1>WHOLESALE</h1>
        <p>
            We do not just distribute gear. 
            We provide the professional tools that empower your facility to build strong bodies and resilient communities. 
            Every product in our wholesale catalog exists for one reason: to support high-performance, intelligent training at scale.
        </p>
    </div>
