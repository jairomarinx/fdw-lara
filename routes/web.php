...
// Todo: Llevar la logica de welcome a la otra vista de raiz. 
// Route::get('/', function () {
//     return view('welcome');
// });
...
Route::prefix('programs')->group(function () {
    ...
    Route::get('/fit-without-gym', [FitController::class, "fit_without_gym2"])->name('fit-without-gym');
    Route::get('/fit-without-gym2', [FitController::class, "fit_without_gym"])->name('fit-without-gym');
